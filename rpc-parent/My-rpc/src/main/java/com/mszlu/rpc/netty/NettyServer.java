...
import com.mszlu.rpc.util.RuntimeUtil;
...
public class NettyServer implements MsServer{
    ...
    public void run() {
        ...
        try {
            ...
            eventExecutors = new DefaultEventExecutorGroup(
                    RuntimeUtil.cpus() * 2,new MsRpcThreadFactory(msServiceProvider));
            ...
            // 绑定端口，同步等待绑定成功
            //msServiceProvider.getMsRpcConfig().getProviderPort()
    ...
    //从msServiceProvider获得注册在nacos上面的Bean
